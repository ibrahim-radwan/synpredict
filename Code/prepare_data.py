...
print("CWD: " + os.getcwd() )
dirpath = '../input/'
labels_file = dirpath + "Oniel_dc_v1.3_bliss.csv"
...
#    cell_line_feat_mt = mt_gene_exp[cell_line_name]
#    cell_line_feat_cnv = cnv_gene_exp[cell_line_name]
...
#    sample['cellLineBN'] = cell_line_feat_bn
    sample['cellLineSC'] = cell_line_feat_scores
#    sample['cellLineMT'] = cell_line_feat_mt
#    sample['cellLineCNV'] = cell_line_feat_cnv
    sample['label'] = label
