...
# labels
target = h5py.File(dirpath + 'data4/zip/target.h5', 'r')
...
#    batch_size_predicted = 32
    ...
    model_name_h5 = '../models/model4_ef/zip/model_fold_' + str(fold_i) + '.h5'
    model2.save_weights(model_name_h5)

    # save indecises
    train_inds_name = '../models/model4_ef/zip/model_train_inds_' + str(fold_i) + '.npy'
    np.save(train_inds_name, train_indices[fold_i])

    test_inds_name = '../models/model4_ef/zip/model_test_inds_' + str(fold_i) + '.npy'
    ...
    np.savetxt('../models/model4_ef/zip/model_target_' + str(fold_i) + '.csv', exp_scores, delimiter=',')

    np.savetxt('../models/model4_ef/zip/model_predicted_' + str(fold_i) + '.csv', predicted_scores, delimiter=',')
